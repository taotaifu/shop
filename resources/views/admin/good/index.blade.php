                    ...
                    <div class="right-aside">
                        <div class="right-page-header">
                            <div class="d-flex">
                                ...
                                <div class="ml-auto">
                                    <input type="text" id="demo-input-search2" placeholder="搜索商品" class="form-control">
                                </div>
                            </div>
                        </div>
                        <div class="table-responsive">
                            <div id="add-contact" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                ...
                                <tr>
                                    ...
                                    <th class="footable-sortable">商品名称<span class="footable-sort-indicator"></span></th>
                                    <th class="footable-sortable">商品图片<span class="footable-sort-indicator"></span></th>
                                    <th class="footable-sortable">商品价格<span class="footable-sort-indicator"></span></th>
                                    <th class="footable-sortable">所属分类<span class="footable-sort-indicator"></span></th>
                                    <th class="footable-sortable">添加时间<span class="footable-sort-indicator"></span></th>
                                ...
                                <tr class="footable-even" style="">
                                    ...
                                    <td>{{$v['title']}}</td>
                                    <td><img src="{{$v['list_pic']}}"></td>
                                    <td>{{$v['price']}}</td>
                                    <td>{{$v->category->name}}</td>
                                    <td>{{$v['created_at']}}</td>
                                    <td>
                                        <a href="{{route ('admin.good.edit',$v['id'])}}" data-toggle="tooltip" data-original-title="Edit"> <i class="fa fa-pencil text-inverse m-r-10"></i> </a>
                                        <a href="javascript:;" onclick="del(this)" data-toggle="tooltip" data-original-title="Close"> <i class="fa fa-close text-danger"></i> </a>
                                        <form action="{{route ('admin.good.destroy',$v)}}" method="post">
                                            @csrf @method('DELETE')
                                        </form>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td colspan="2">
                                        <button type="button" class="btn btn-info btn-rounded" data-toggle="modal" data-target="#add-contact">添加商品</button>
                                    </td>
                                </tr>
                                </tfoot>
                            </table>
